...
public class ColorPickerDialog extends Dialog {
	...
	private static class ColorPickerView extends View {
		...
		ColorPickerView(Context c, OnColorChangedListener l, int color, int defaultColor) {
			...
			mPaint.setTypeface(Main.fontRegular);//change by me
			mPaint.setTextSize(24);//change by me
		}
		...
		protected void onDraw(Canvas canvas) {
			...
			if (Color.red(mCurrentColor)+Color.green(mCurrentColor)+Color.blue(mCurrentColor) < 384)
				...
				mPaint.setColor(Color.BLACK);
			canvas.drawText(getResources().getString(R.string.select_color), 74, 340, mPaint);
			...
			if (Color.red(mDefaultColor)+Color.green(mDefaultColor)+Color.blue(mDefaultColor) < 384)
				...
				mPaint.setColor(Color.BLACK);
			canvas.drawText(getResources().getString(R.string.default_color), 202, 340, mPaint);
		}
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.select_color_title);
    }
}
